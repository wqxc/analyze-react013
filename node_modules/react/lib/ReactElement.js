...
/*
用symbol来表示 ReactElement type，如果当前环境不支持symbol或者是没有 polyfill。就用一个普通的数字
来表示
*/ 
...
/*
  ReactElement 方法最终会返回一个element 对象。里边包含的是 type，key，props等属性
*/  
...
ReactElement.createElement = function (type, config, children) {
  ...
  */ 
  ...
  /*
    Children，可能是一个或者是多个。将他们遍历一些并放在props的 children中
  */ 
  ...
  // 如果type是一个React组件 比如 App之类的。那么组件本身会有一个defautProps 属性定义默认的属性值。 
